...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        check = Transaction.objects.filter(bankrupt_check=False).first()
        print(check)
...
class TransferMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self,form):
        ...
        print(reciver_account_no,'reciver')
        sender_account=self.request.user.account
        print(sender_account,'sender')
        reciver_bank_account=UserBankAccount.objects.get(account_no=reciver_account_no)
        print(reciver_bank_account.account_no)
        if reciver_bank_account is not None:
            ...
            send_transaction_email(self.request.user,amount,'Transfer Money Messager','transactions/transfer_money_email.html')
            send_transaction_email(reciver_bank_account.user, amount, "Recive Money Message", "transactions/reciver_money_email.html")
        else:
            messages.warning('The account number not found')
